...
public class CommonPassWord {
    public static class RandomStringExmple {
        ...
        public String randomAlphaNumeric(int numberOfCharactor) {
            ...
            for (int i = 0; i < numberOfCharactor; i++) {
                int number = randomNumber(0, (alpha + alpha.toUpperCase() + digits).length() - 1);
                char ch = (alpha + alpha.toUpperCase() + digits).charAt(number);
                sb.append(ch);
            }
            return sb.toString();
        }
        ...
        public String randomPassword(int numberOfCharactor) {
            ...
            while (result.size() < numberOfCharactor) {
                appendChar.accept(alpha + alpha.toUpperCase() + digits + specials);
            }
