package com.lethanh219049.application.config;
...
public class Constant {
    ...
    public static final List<Integer> LIST_ORDER_STATUS = new ArrayList<>(
            Arrays.asList(ORDER_STATUS, DELIVERY_STATUS, COMPLETED_STATUS, RETURNED_STATUS, CANCELED_STATUS));

    // Loại khuyến mại
    public static final int DISCOUNT_PERCENT = 1;
    public static final int DISCOUNT_AMOUNT = 2;
    public static String CHANGE_PASSWORD = "send-email";
